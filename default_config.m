...
cfg.model.v3.stage = 'calibration_guarded_ard_anchored_task_refinement';
...
cfg.model.v3.lambdaSingle = 0.04;
cfg.model.v3.lambdaPair = 0.03;
cfg.model.v3.lambdaMid = 0.01;
...
cfg.model.v3.taskPairSelectionMode = 'coverage';
cfg.model.v3.guardHeldoutCount = 64;
cfg.model.v3.taskSnrDb = 25;
cfg.model.v3.numSpsaIterations = 8;
cfg.model.v3.learningRate = 0.005;
cfg.model.v3.perturbationScale = 0.005;
